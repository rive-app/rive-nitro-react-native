...
import com.margelo.nitro.rive.*

/**
 * Represents the React Native `ViewManager` for the "RiveView" Nitro HybridView.
 */
public class HybridRiveViewManager: SimpleViewManager<View>() {
  init {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridRiveView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    val hybridView = view.getTag(associated_hybrid_view_tag) as? HybridRiveView
      ?: throw Error("Couldn't find view $view in local views table!")

    // 1. Update each prop individually
    hybridView.beforeUpdate()
    HybridRiveViewStateUpdater.updateViewProps(hybridView, stateWrapper)
