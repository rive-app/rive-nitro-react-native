...
struct JHybridRiveLoggerSpecImpl: public jni::JavaClass<JHybridRiveLoggerSpecImpl, JHybridRiveLoggerSpec::JavaPart> {
  static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rive/HybridRiveLogger;";
  static std::shared_ptr<JHybridRiveLoggerSpec> create() {
    static const auto constructorFn = javaClassStatic()->getConstructor<JHybridRiveLoggerSpecImpl::javaobject()>();
