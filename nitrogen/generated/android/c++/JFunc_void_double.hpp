...
namespace margelo::nitro::rive {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rive/Func_void_double;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rive/Func_void_double_cxx;";
