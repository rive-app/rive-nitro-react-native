...
namespace margelo::nitro::rive {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/rive/Func_void_double;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/rive/Func_void_double_cxx;";
