...
namespace margelo::nitro::rive {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "RiveEvent" and the the Kotlin data class "RiveEvent".
   */
  struct JRiveEvent final: public jni::JavaClass<JRiveEvent> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/rive/RiveEvent;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct RiveEvent by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    RiveEvent toCpp() const {
