...
namespace margelo::nitro::rive {
  ...
  namespace JEventPropertiesOutput_impl {
    class First: public jni::JavaClass<First, JEventPropertiesOutput> {
    public:
    ...
    class Second: public jni::JavaClass<Second, JEventPropertiesOutput> {
    public:
    ...
    class Third: public jni::JavaClass<Third, JEventPropertiesOutput> {
    public:
