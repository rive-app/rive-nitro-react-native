...
namespace margelo::nitro::rive {
  ...
  public:
    ...
    explicit HybridViewModelColorPropertySpecSwift(const RNRive::HybridViewModelColorPropertySpec_cxx& swiftPart):
  ...
  public:
    // Get the Swift part
    inline RNRive::HybridViewModelColorPropertySpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  public:
    ...
    bool equals(const std::shared_ptr<HybridObject>& other) override {
      if (auto otherCast = std::dynamic_pointer_cast<HybridViewModelColorPropertySpecSwift>(other)) {
  ...
  private:
    RNRive::HybridViewModelColorPropertySpec_cxx _swiftPart;
  };
