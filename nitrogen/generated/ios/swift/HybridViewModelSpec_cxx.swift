...
open class HybridViewModelSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridViewModelSpec_cxx) -> Bool {
  ...
  @inline(__always)
  public final func getPropertyCountAsync() -> bridge.Result_std__shared_ptr_Promise_double___ {
    do {
      let __result = try self.__implementation.getPropertyCountAsync()
  ...
  @inline(__always)
  public final func getInstanceCountAsync() -> bridge.Result_std__shared_ptr_Promise_double___ {
    do {
      let __result = try self.__implementation.getInstanceCountAsync()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_double__ in
        let __promise = bridge.create_std__shared_ptr_Promise_double__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_double__(__promise)
        __result
  ...
  @inline(__always)
  public final func createDefaultInstanceAsync() -> bridge.Result_std__shared_ptr_Promise_std__optional_std__shared_ptr_HybridViewModelInstanceSpec_____ {
    do {
      let __result = try self.__implementation.createDefaultInstanceAsync()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__optional_std__shared_ptr_HybridViewModelInstanceSpec____ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__optional_std__shared_ptr_HybridViewModelInstanceSpec____()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__optional_std__shared_ptr_HybridViewModelInstanceSpec____(__promise)
        __result
