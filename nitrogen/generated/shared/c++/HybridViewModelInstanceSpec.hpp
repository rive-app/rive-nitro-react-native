...
namespace margelo::nitro::rive {
  ...
  class HybridViewModelInstanceSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::optional<std::shared_ptr<HybridViewModelInstanceSpec>> viewModelInstanceProperty(const std::string& path) = 0;
      virtual bool setViewModelInstanceProperty(const std::string& path, const std::shared_ptr<HybridViewModelInstanceSpec>& instance) = 0;
