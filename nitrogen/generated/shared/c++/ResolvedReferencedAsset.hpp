...
namespace margelo::nitro::rive {
   ...
   */
  struct ResolvedReferencedAsset {
  public:
...
namespace margelo::nitro {
  ...
  struct JSIConverter<margelo::nitro::rive::ResolvedReferencedAsset> final {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::rive::ResolvedReferencedAsset& arg) {
      ...
      obj.setProperty(runtime, "sourceUrl", JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.sourceUrl));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, "sourceUrl"))) return false;
