...
namespace margelo::nitro::rive {
  ...
  /**
   * A struct which can be represented as a JavaScript object (RiveEvent).
   */
  struct RiveEvent {
  public:
...
namespace margelo::nitro {
  ...
  // C++ RiveEvent <> JS RiveEvent (object)
  template <>
  struct JSIConverter<margelo::nitro::rive::RiveEvent> final {
    static inline margelo::nitro::rive::RiveEvent fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::rive::RiveEvent(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::rive::RiveEvent& arg) {
