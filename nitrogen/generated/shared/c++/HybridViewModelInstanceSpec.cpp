...
namespace margelo::nitro::rive {
  ...
  void HybridViewModelInstanceSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridMethod("getPropertiesAsync", &HybridViewModelInstanceSpec::getPropertiesAsync);
      ...
      prototype.registerHybridMethod("viewModelAsync", &HybridViewModelInstanceSpec::viewModelAsync);
